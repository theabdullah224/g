      ...
      <div className="savemoney">
        <div className="left-content-2  mt-8 sm:mt-0" id="aboutleft">
          <div className="contentsave">
            ...
            {/* Subheading explaining the meal planner */}
            ...
            {/* Paragraph explaining the benefits of the meal planner */}
          </div>
          ...
          <div className=" mt-4 flex-wrap flex gap-2 w-fit h-fit sm:gap-4">
            ...
            >
              ...
              {/* Attach click handler to navigate to "Sign Up" */}
              Sign&nbsp;Up
            </button>
}
          </div>
        ...
        <div className="image-sidesavemoney " id="imageabout">
          <div className="image">
            <div
              ...
              style={{
                backgroundImage: `url(${lastimg})`, // Setting background image for the right-side image section
                transform: `scaleX(1)`, // Applying horizontal scaling transformation
              }}
            >
              <img
                className="favicon-2"
                src={Favicon} // Rendering the favicon image
                alt="" // Alt text for the image
                style={{ transform: `scaleX(1)` }} // Applying horizontal scaling transformation to the image
              />
            </div>
          </div>
        </div>
